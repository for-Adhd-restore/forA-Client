        ...
        <View style={styles.Onboarding}>
            <View style={styles.OnboardingContents}>
                <Text style={text.OnboardingStepText}>
                    내가 <Text style={{ color: '#52A55D' }}>ADHD</Text>일까,
                    오늘도 실수한 '나'
                </Text>
                <Text style={text.OnboardingStepText}>다들 어떻게 지내?</Text>
                <Text style={text.OnboardingStepText}>
                    <Text style={{ color: '#52A55D' }}>오늘탭</Text>에서 나의
                    오늘을 공유해 봐!
                </Text>
                <Image
                    source={require('@/public/assets/onboardingStep1Phone.png')}
                    style={styles.OnboardingStepPhone}
                />
            </View>
            <View style={styles.buttonContainer}>
                <Image
                    source={require('@/public/assets/onboardingStep1Pagination.png')}
