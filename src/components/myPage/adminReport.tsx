...
export default function AdminReport() {
    ...
    const handleReportAction = async (actionType: string) => {
        ...
        try {
            const response = await postHandleReport(
                ...
                <View style={styles.modalContainer}>
                    <View style={styles.modalContent}>
                        <Text style={styles.modalTitle}>
                            {selectedReport?.email}아이디에 조치를 취하겠습니까?
                        </Text>
                        <TouchableOpacity
                            onPress={() => handleReportAction('DAY_2_PAUSE')}
                        >
                        ...
                        <TouchableOpacity
                            onPress={() => handleReportAction('DAY_ALL_PAUSE')}
                        >
                            <Text style={styles.modalOption}>
                                영구 활동 정지와 글 삭제
                            </Text>
                        ...
                        <TouchableOpacity
                            onPress={() => handleReportAction('POST_DELETE')}
                        >
                            <Text style={styles.modalOption}>
                                글만 삭제하기
                            </Text>
